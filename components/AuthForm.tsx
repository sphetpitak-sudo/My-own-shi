        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="mt-4 w-full py-2.5 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
            >
