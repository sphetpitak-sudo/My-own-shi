...
const translations = {
  en: {
    ...
    hero_headline: "Reveal your path",
    hero_subheadline: "Personal tarot readings powered by AI — calm, deep, and made for you",
  ...
  th: {
    ...
    hero_headline: "เปิดไพ่ชะตาของคุณ",
    hero_subheadline: "คำทำนายไพ่ทาโรต์ที่ขับเคลื่อนด้วย AI — สงบ ลึกซึ้ง และเป็นส่วนตัวสำหรับคุณ",
    hero_cta: "เริ่มดูดวง",
    hero_brand: "ไพ่ทาโรต์ · AI",
    ai_reading: "AI ทำนาย",
