...
export const FEATURES: FeatureMeta[] = [
  ...
  },
  {
    ...
    status: "live",
    cost: 15,
    route: "/dashboard/reading?spread=three_card&topic=love",
    theme: "rose",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
  {
    ...
    status: "live",
    cost: 15,
    route: "/dashboard/reading?spread=three_card&topic=career",
    theme: "teal",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
  {
    ...
    status: "live",
    cost: 15,
    route: "/dashboard/reading?spread=three_card&topic=study",
    theme: "violet",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
  {
    ...
    status: "live",
    cost: 15,
    route: "/dashboard/reading?spread=three_card&topic=finance",
    theme: "amber",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
  {
    ...
    status: "live",
    cost: 15,
    route: "/dashboard/reading?spread=three_card&topic=health",
    theme: "teal",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
  ...
  },
  {
    ...
    category: "astrology",
    title: "Daily Zodiac",
    titleTh: "ดูดวงตามวันเกิด",
    subtitle: "Horoscope by birth date",
    subtitleTh: "ราศี + ปีนักษัตร",
    descriptionTh: "ใส่วันเกิด เพื่อดูราศี ปีนักษัตร และคำทำนายประจำวัน ครอบคลุม เรียน/งาน ความรัก เงิน สุขภาพ และความเครียด",
    icon: Star,
    status: "live",
    cost: 0,
    route: "/dashboard/zodiac",
    theme: "indigo",
    badge: "ฟรี",
    badgeTh: "ฟรี",
  },
  {
    ...
    descriptionTh: "สร้างแผนที่ดวงดาวจากวัน เวลา และสถานที่เกิด เพื่อดูตำแหน่งดาวเคราะห์ 12 เรือน Whole Sign",
    icon: Compass,
    status: "live",
    cost: 25,
  ...
  },
  {
    ...
    category: "astrology",
    title: "Atlas",
    titleTh: "Atlas แผนที่โลก",
    subtitle: "AstroCartography 40 lines",
    subtitleTh: "แผนที่ 40 เส้น + 189 เมือง + Saju",
    descriptionTh: "40 เส้นดาว (MC/IC ตั้ง, AC/DC โค้ง) จัดอันดับ 189 เมืองทั่วโลก ผูกธาตุ Saju ที่ขาดกับดาวเสริม",
    icon: Globe,
    status: "live",
    cost: 25,
    route: "/dashboard/atlas",
    theme: "indigo",
    badge: "ใหม่",
    badgeTh: "ใหม่",
  },
