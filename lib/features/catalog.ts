...
export const FEATURES: FeatureMeta[] = [
  ...
  },
  {
    ...
    category: "astrology",
    title: "Daily Zodiac",
    titleTh: "ดูดวงตามราศี",
    subtitle: "Horoscope by sign",
    subtitleTh: "ตามราศีของคุณ",
    descriptionTh: "ดูดวงรายวันตามราศีทั้ง 12 — ความรัก การงาน การเงิน สุขภาพ และเลขมงคล อัปเดตทุกวัน",
    icon: Star,
    status: "live",
    cost: 0,
